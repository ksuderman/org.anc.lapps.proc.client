 ...
 */
public class RemoteService extends AbstractSoapClient implements WebService
{
   public RemoteService(String url, String user, String password) throws ServiceException
   {
      super(url, url);
   ...
   public RemoteService(Server server, String endpoint) throws ServiceException
   {
